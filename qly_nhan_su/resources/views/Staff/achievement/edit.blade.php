        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type='text' name="name" class="form-control" value='{{ $achievement->ten }}'>
                </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" name='degree_day' value='{{ $achievement->ngaycap }}'>
                </div>

                <div class="form-group col-md-6">
                    <label>Mô tả (không bắt buộc)</label>
                    <textarea name="desc" class="form-control">{{ $achievement->mota }}</textarea>
                </div>
            </div>

            <div class="form-group float-right">
                <label>nhân viên:</label>
                <div>{{ $achievement->nhanvien->ho. ' '. $achievement->nhanvien->ten }}</div>
            </div>
